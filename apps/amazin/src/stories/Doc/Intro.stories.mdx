...
## What is Amazim (React Amazon Clone)?

There have been a handful of Amazon-cloned apps written out there but I have not found anyone even closed to the original, which makes me wonder **why don't I try it with React**? And here we go.
This is not only an online shop/ platform clone built with a js-framework, but also an example of experimenting some **modern**, **real-world**, **maybe unstable** React APIs, Nx, Mobile friendly PWA and also some Backend technologies in my freetime.
...
I had to break the big task into smaller parts and do it step by step.

### "Divide to conquer!" - Lao Tsu.

Yes, **Learning by Doing ** that's my approach. If you see a long path ahead, don't heap or run or give up, just divide the path to steps and make (conquer) the first one, and then another one.
...
[stackFE]: https://github.com/ntrix/amazin/apps/amazin/src/stories/img/nx-react-cy.jpeg
[stackBE]: https://github.com/ntrix/amazin/apps/amazin/src/stories/img/node-express-vercel-heroku.jpeg
[demo]: https://github.com/ntrix/amazin/apps/amazin/src/stories/img/amazon-clone-react-demo-ntien.gif
