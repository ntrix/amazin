...
| ---- | ------------------------------------------------------------------------------- | ------ |
| 01a  | [Database: MongoDB][atlas]                                                      | Done   |
| 01b  | [Backend Simple Version][BE]                                                    | Done   |
| 02a  | [Frontend Project][FE]                                                          | Done   |
| 02b  | [Migration to Nx][Nx]                                                           | Done   |
| 03a  | [Testing With React][testing]                                                   | Doing  |
| 03b  | [Performance & Experiment some unstable React API][reactAPI]                    | Done   |
| 03c  | [E2E testing with Cypress][cy]                                                  | Doing  |
| 04a  | [AWS Cloud Backend?][aws]                                                       | **Todo**   |
| 04b  | [Backend DB cache][redis]                                                       | Doing  |
| 05   | [AB Testing, Error Tracing (React Profiler?)][profiler]                         | **Todo**   |
| ..   | ..                                                                              | ..     |
| 09a  | [StoryBook UI Components, separate UI/UI libs][storybook]                       | Done   |
...
[stackBE]: hhttps://raw.githubusercontent.com/ntrix/amazin/nx/apps/amazin/src/stories/img/mongo-expresss-react-node-heroku-dbatlas.jpeg
